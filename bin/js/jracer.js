...
var width          = 480;                    // logical canvas width
...
var stats          = {update: function() {}} //Game.stats('fps');       // mr.doobs FPS counter
...
function render() {
  ...
  Render.pitchMeter(ctx, speed/maxSpeed, pitch, minPitch, maxPitch, maxPitchError);
}
